...
const BattleGround = ({ selectedCharacter, monsters }: BattleGroundProps) => {
	...
	const loadMonster = (monster: MonsterStats) => {
		...
		monster && setMonsterAC(monster.AC[0].value)
							...
							{monsterCurrentHP !== null && monsterHP !== null && (
								<>
									...
									<progress
										...
										max={monsterHP.toString()}></progress>
									<p>
					...
					<div className='character-box'>
						<div className='character-display'>
							<progress
								...
								max={playerHP.toString()}></progress>
							<p>
						...
						<div className='button-section'>
							...
							<button
								...
								{playerSpecial.split(' ')[0]}{' '}
								{playerSpecial.split(' ')[1].slice(0, -1)}
							</button>
						</div>
					</div>
