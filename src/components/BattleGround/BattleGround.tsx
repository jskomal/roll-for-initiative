...
import { rollDice, rollToHit, checkForHit, rollDamage, doDamage, healingWord } from "../../battle-utils";
...
const BattleGround = () => {
  ...
  const [playerInit, setPlayerInit] = useState<number>(player.initiative)
